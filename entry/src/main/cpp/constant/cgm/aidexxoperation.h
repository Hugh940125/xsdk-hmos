...
public:
    ...
    static const uint16 KEEP_LONG_CONNECT = 0xFFFE;

    static const uint16 GET_LOG_RANGE = 0xE000;
    static const uint16 GET_LOG = 0xE010;
    static const uint16 GET_ERROR_LOG = 0xE020;
};
